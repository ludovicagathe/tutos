            ...
            <v-card>
              <v-container>
                <v-form @submit.prevent="addEvent">
                  ...
                  <v-text-field v-model="details" type="text" label="event details (required)"></v-text-field>
                  ...
                  <v-text-field v-model="color" type="color" label="label color (click to pick)"></v-text-field>
            ...
            <v-menu v-model="selectedOpen" :close-on-content-click="false" :activator="selectedElement" full-width offset-x>
              <v-card color="grey lighten-4" min-width="350px" flat>
                ...
                <v-card-text>
                  ...
                  <form v-else>
                    <textarea-autosize v-model="selectedEvent.details" type="text" style="width: 100%" :min-height="100" placeholder="Edit event details"></textarea-autosize>
                  </form>
                </v-card-text>
                <v-card-actions>
                  ...
                  <v-btn text color="danger" v-if="currentlyEditing !== selectedEvent.id" @click.prevent="editEvent(selectedEvent)">
                    Edit
                  </v-btn>
                  <v-btn text color="success" v-else @click.prevent="updateEvent(selectedEvent)">
                    Save
                  </v-btn>
                </v-card-actions>
              </v-card>
